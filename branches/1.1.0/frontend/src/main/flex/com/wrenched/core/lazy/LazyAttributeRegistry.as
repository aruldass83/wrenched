	...
	public class LazyAttributeRegistry {
		...
		*/
		static function getRegisteredClassName(obj:Object):String {
			...
			var type:Type = Type.forInstance(obj, ApplicationDomain.currentDomain)/*Type.getType(obj)*/;

			while (!(className && classes.hasOwnProperty(className)) && type != null/* && (type != Type.getType(Object))*/) {
				className = type.name;
				type = type.superclass/*type.baseType*/;
			}
...
//			trace("LOLOL", proxyDomain.getDefinition(className));
